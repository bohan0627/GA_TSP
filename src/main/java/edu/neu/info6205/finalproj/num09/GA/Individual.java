...
public class Individual {
    ...
    public static Individual clone( Individual in ) {
    ...
    public static ArrayList<Individual> crossover(Individual in1, Individual in2) {
        ...
        Individual child1 = clone(in1);
        Individual child2 = clone(in2);
    ...
    public static ArrayList<Individual> crossover(Individual in1, Individual in2, int min, int max) {
        if ( in1 == null || in2 == null ) { //check the parent
            return null;
        }
        if (in1.getGenotype() == null || in2.getGenotype() == null) { //check the parent's genotype
    ...
    /**
     * encode CityNode to GA's Individual
     * @param city
     */
